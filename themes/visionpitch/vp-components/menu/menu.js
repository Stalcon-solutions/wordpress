class Menu {
	constructor(props) {
		...
		let mailBlock='';
		let phoneBlock=''
		if (props.emai!==undefined){
			mailBlock=`<span class="material-icons">mail_outline</span><a href="mailto:${props.email}" rel="noopener">${props.email}</a>`;
		}
		if (props.phone!==undefined){
			phoneBlock=`<span class="material-icons">phone</span><a href="tel:${props.phone}" rel="noopener">${props.phone}</a><br>`;
		}
